...
#define DRAW_POINT(Location) if (GetWorld()) DrawDebugPoint(GetWorld(), Location + Forward * 100.f, 15.f, FColor::Red, true);
#define DRAW_POINT_SingleFrame(Location) if (GetWorld()) DrawDebugPoint(GetWorld(), Location + Forward * 100.f, 15.f, FColor::Red, false);
